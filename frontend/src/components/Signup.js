                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    <label for="email" className="block mb-2 text-base font-medium text-gray-900 dark:text-white">Admin name</label>
                                ...
                                <p className="text-base font-normal text-gray-800 dark:text-gray-400">
                                    Have an account already? <a href="#" className="font-medium text-lg text-teal-500 hover:underline dark:text-primary-500">Login</a>
                                </p>
                            </form>
                        </div>
                    </div>
